...
EMR_EKS_RELEASE_LABEL="emr-7.3.0-spark-rapids-latest"
...
#TODO - Remove S3 Bucket Name
S3_BUCKET=""
EMR_VIRTUAL_CLUSTER_ID=""
EMR_EXECUTION_ROLE_ARN="arn:aws:iam::<acct_id>:role/emr-spark-rapids-emr-ml-team-a"
CLOUDWATCH_LOG_GROUP="/emr-on-eks-logs/emr-spark-rapids/emr-ml-team-a/"
...
aws emr-containers start-job-run \
  ...
  --job-driver '{
    "sparkSubmitJobDriver": {
      "entryPoint": "'"$SCRIPTS_S3_PATH"'/transform.py",
