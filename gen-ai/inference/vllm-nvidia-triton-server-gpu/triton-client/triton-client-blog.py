            ...
            async for response in response_iterator:
                ...
                if error:
                    ...
                    for i in output:
                        ...
                        print(f"Model {FLAGS.model_name} - Request {prompt_id}: {end_to_end_latency:.2f} seconds, {token_throughput_per_sec:.2f} tokens/sec, Input Tokens: {input_token_count}, Output Tokens: {output_token_count}")
    ...
    with open(FLAGS.results_file, "w") as file:
        for key, val in results_dict.items():
            file.write(
                ...
                f"Token Throughput per Second: {val['Token Throughput per Second']}\n"
